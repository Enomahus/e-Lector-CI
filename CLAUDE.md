# E-Lector-CI CLAUDE.md

## Project Overview

**E-Lector CI** - A monorepo with an Angular 21 frontedn and ASP.NET Core (.NET 10) backend.
...
npm run generate-api-client  # Regenerate NSwag API client from backend Swagger
```
...
Access traces at http://localhost:41100/search (local dev).
