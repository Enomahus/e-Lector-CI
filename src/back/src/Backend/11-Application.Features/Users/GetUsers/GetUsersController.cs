...
namespace Application.Features.Users.GetUsers
{
    ...
    public class GetUsersController : ApiControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Result<PagedList<GetUsersResponse>>))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(Result<Error>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Result<Error>))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(Result<Error>))]
        public Task<Result<PagedList<GetUsersResponse>>> GetUsers([FromBody] GetUsersQuery query, CancellationToken cancellationToken)
        {
