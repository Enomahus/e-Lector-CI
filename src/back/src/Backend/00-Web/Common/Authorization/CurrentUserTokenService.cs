...
namespace Web.Common.Authorization
{
        ...
        ICurrentUserEntityPermissionsProvider<long>
    {
        ...
        public Guid? ImpersonatorId => throw new NotImplementedException();

        public string? ImpersonatorEmail => throw new NotImplementedException();
        ...
        public override Task<bool> IsCurrentUserAuthenticatedAsync(CancellationToken cancellationToken = default)
        {
