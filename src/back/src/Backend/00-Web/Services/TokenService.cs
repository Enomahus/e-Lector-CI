    ...
    ): ITokenService
    {
        ...
        private SigningCredentials GetSigningCredentials()
        {
            var secretStr =
                ...
                ?? throw new ConfigurationMissingException("Missing configuration : JwtConfig.Secret");
        ...
        )
        {
            ...
            if (impersonatorUser != null)
            {
                ...
                [
                    .. claims,
                    new(AppConstants.ImpersonatorIdClaim, impersonatorUser.Id.ToString()),
                    new(AppConstants.ImpersonatorEmailClaim, impersonatorUser.UserName?.ToString() ?? ""),
                ];
            }
        ...
        )
        {
            var newToken = new RefreshTokenDao()
            {
                ...
                Expiry = DateTimeOffset.Now.AddMinutes(tokenConfig.Value.RefreshTokenExpirationMinutes),
            };
