...
export class CountryCode {
  public allCountries: (
    | [string, CountryISO, string]
    | [string, CountryISO, string, number | undefined]
    | [string, CountryISO, string, number | undefined, string[] | undefined]
  )[] = [
    ...
    ['Northern Mariana Islands', 'nf', '1670'],
