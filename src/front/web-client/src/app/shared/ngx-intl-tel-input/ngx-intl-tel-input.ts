...
import { PhoneNumberFormat } from '@app/enums/phone-number-format.enum';
import { SearchCountryField } from '@app/enums/search-country-field.enum';
import { Country } from '@app/models/country.model';
import * as lpn from 'google-libphonenumber';
import { CountryCode } from '../phone-input/data/country-code';
import { ChangeData } from '../phone-input/interfaces/change-data';

@Component({
  selector: 'app-ngx-intl-tel-input',
  templateUrl: './ngx-intl-tel-input.html',
  styleUrls: ['./bootstrap-dropdown.css', './ngx-intl-tel-input.css'],
  standalone: true,
  ...
  providers: [
    CountryCode,
    {
      ...
      useExisting: forwardRef(() => NgxIntlTelInput),
      multi: true,
    },
  ],
})
export class NgxIntlTelInput implements OnInit, OnChanges, ControlValueAccessor {
  ...
  */
  ...
  public searchCountry() {
    ...
    const country = this.allCountries.filter((c) => {
      if (this.searchCountryField.indexOf('all') > -1) {
  ...
  public onPhoneNumberChange(): void {
    ...
    if (!this.value) {
      ...
      this.phoneNumber = this.phoneUtil.format(number, lpn.PhoneNumberFormat.NATIONAL);
